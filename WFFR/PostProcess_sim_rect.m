function postout = ...
            PostProcess_sim_rect(MCMC_beta,MCMC_alpha,MCMC_flag_theta,MCMC_tau,MCMC_pi,MCMC_theta,theta,model,wavespecsc,wavespecsy,pcaspecsx,twosample,get_sigma,sampleU,MCMC_U)
...
%             end;
  ...
  %             temp                        = zeros(size(Betai(2:end,:)',1),length(wavespecsc.keep)); %MZ
  %             added 11/4/18
